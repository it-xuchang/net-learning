package com.netlearning.file.service.impl;
...
import com.netlearning.file.dao.FileRepository;
import com.netlearning.file.service.FileService;
import com.netlearning.framework.domain.filesystem.FileSystem;
import com.netlearning.framework.domain.filesystem.response.FileSystemCode;
...
public class FileServiceImpl implements FileService {
    ...
    @Value("${netlearning.fastdfs.tracker_servers}")
    String tracker_servers;
    
    @Value("${netlearning.fastdfs.connect_timeout_in_seconds}")
    int connect_timeout_in_seconds;
    
    @Value("${netlearning.fastdfs.network_timeout_in_seconds}")
    int network_timeout_in_seconds;
    
    @Value("${netlearning.fastdfs.charset}")
    String charset;
  ...
  //上传文件到fastDFS
	...
	public UploadFileResult upload(MultipartFile multipartFile, String filetag, String businesskey, String metadata) {
        ...
        fileRepository.save(fileSystem);
