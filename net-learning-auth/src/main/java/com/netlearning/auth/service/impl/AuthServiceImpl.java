...
import com.netlearning.auth.service.AuthService;
...
import com.netlearning.framework.domain.ucenter.response.AuthCode;
...
public class AuthServiceImpl implements AuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose(NetLearningServiceList.NET_LEARNING_AUTH);
        //此地址就是http://ip:port
